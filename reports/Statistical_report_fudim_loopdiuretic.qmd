...
In order to assess how robust the association between loop diuretic and the outcomes are 
to residual confounding the E-value 
was calculated[@evalue] [@evalue2]. The HR/RR used are from the adjusted models. 
Approximate conversions of the HR to RR are applied, assuming a non-rare outcome. 
The E-value is interpreted as the minimum Risk Ratio 
