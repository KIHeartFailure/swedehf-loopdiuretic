...
kmfunc <- function(time, event, eventname, xvar = "shf_loopdiuretic_cat", data, endfollow = 3, labposadj = c(-0.06, -0.06, 0.12)) {
  ...
  p <- ggplot(plot_data, aes(x = time / 365.25, y = 1 - estimate, color = strata)) +
    ...
    annotate("text", x = 1.4, y = .85, label = cox, hjust = 0.5, size = 6)
  ...
  #  annotation_custom(grid::textGrob("No COPD", rot = 0),
  #               xmin = -0.5, xmax = -2.5, ymin = 1)
  # annotation_custom(grid::textGrob("COPD", rot = 0),
  #                 xmin = 1, xmax = -0.6, ymin = 5)
...
mcffunc <- function(event, eventno, eventname, xvar = "shf_loopdiuretic_cat", data, datarec,
                    endfollow = 3, labposadj = c(-0.1, -0.1, -0.1)) {
  levs <- levels(data %>% pull(!!sym(xvar)))
  nlevs <- length(levs)
  ...
  p <- ggplot(plot_data, aes(x = time / 365.25, y = estimate, color = strata)) +
    ...
    annotate("text", x = 1.4, y = 2.1, label = cox, hjust = 0.5, size = 6)
...
```{r}
#| label: fig-cvd-1hfh-pop-1
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve CVD/HFH - Population 1"
...
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve CVD - Population 1"
...
kmfunc(
  ...
  eventname = "CVD",
  data = rsdata %>% filter(pop1),
  labposadj = c(-0.05, 0.08, 0.1)
)
```

```{r}
#| label: fig-1hfh-pop-1
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve HFH - Population 1"
...
```{r}
#| label: fig-tothfh-pop-1
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Mean cumulative function total HFH - Population 1"
...
```{r}
#| label: fig-cvd-tothfh-pop-1
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Mean cumulative function CVD/total HFH - Population 1"
...
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve All-cause mortality - Population 1"
...
kmfunc(
  ...
  data = rsdata %>% filter(pop1),
  labposadj = c(-0.06, 0.11, 0.12)
)
```

```{r}
#| label: fig-cvd-1hfh-pop-2
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve CVD/HFH - Population 2"
...
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve CVD - Population 2"
...
```{r}
#| label: fig-1hfh-pop-2
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve HFH - Population 2"
...
```{r}
#| label: fig-tothfh-pop-2
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Mean cumulative function total HFH - Population 2"
...
```{r}
#| label: fig-cvd-tothfh-pop-2
#| cache: true
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Mean cumulative function CVD/total HFH - Population 2"
...
#| cache.comments: false
#| dependson: kmfunc
#| fig-cap: "Cumulative incidence curve All-cause mortality - Population 2"
